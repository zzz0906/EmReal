...
class MinitaurTrottingEnv(minitaur_gym_env.MinitaurGymEnv):
  ...
  def _convert_from_leg_model(self, leg_pose):
    ...
    #print("----------------")
    #print("motor_pose : {}".format(motor_pose))
    #print("----------------")
    return motor_pose
  ...
  def transform_action_to_motor_command(self, action):
    ...
    '''
    print("----------------")
    print("num of legs {}".format(NUM_LEGS))
    print("after swing offset action: {}".format(action))
    print("after swing offset action: {}".format(action))
    print("----------------")
    '''
